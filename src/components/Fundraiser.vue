            ...
            <el-card shadow="hover">
              ...
              <el-collapse>
                <el-collapse-item :name="index">
                  <template slot="title">
                    Read More <i class="header-icon el-icon-info"></i>
                  </template>
      ...
      collapseData: [
        {
          ...
          position: '籌款隊長',
          year: '1年10個月',
          img: 'https://secured.greenpeace.org/hk/Global/hk/artworks/gp/ddc-recruitment/2018/yumi_intro.jpg',
        ...
        },
        {
          ...
          position: '籌款主管',
          year: '4年6個月',
          img: 'https://secured.greenpeace.org/hk/Global/hk/artworks/gp/ddc-recruitment/2018/wayne_intro.jpg',
          intro: '原來她家住劏房仍堅持捐款，更表示「支持一世」，那個感動時刻至今記憶猶新。',
          contentTitle: [
            '你現在的職位是？主要職責是甚麼？',
        ...
        },
        {
          ...
          position: '籌款隊長',
          year: '2年4個月',
          img: 'https://secured.greenpeace.org/hk/Global/hk/artworks/gp/ddc-recruitment/2018/sky_intro.jpg',
          intro: '我們在香港紮根20多年來，從不接受政商界捐款，秉持獨立、公正守護環境',
          contentTitle: [
            '街頭工作抱負？',
            '對籌款工作的誤解',
            '綠色和平保護環境，得個「講」字？',
        ...
        },
        {
          ...
          position: '籌款幹事',
          year: '8個月',
          img: 'https://secured.greenpeace.org/hk/Global/hk/artworks/gp/ddc-recruitment/2018/gloria_intro.jpg',
